...
<main id="main" class="main">
    <section class="section dashboard">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h4 class="mt-5 mb-2 text-gray-800"><strong>Department Data</strong></h4>
        </div>
...
<div class="row">
            <div class="col-md-10">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="table_depart" class="display" style="width:100%">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel"><strong> Department</strong></h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" class="form-control" name="id_depart" id="id_depart">
                         <div class="mb-3">
                          <label for="recipient-name" class="col-form-label">Department Name:</label>
                          <input type="text" class="form-control" name="nameDepart" id="nameDepart">
                        </div>
                        </div>
   ...
   <script type="text/javascript">
      var table = $("#table_depart").DataTable({
        processing: true,
        serverSide: true,
   ...
   $("#btnDeleteYes").click(function (e){
      ...
      console.log("OK"+id_depart)
      $.ajax({
        url: "depart/delete/" +id_depart,
        type: "GET",
        success: function(data){
          table.clear();
          table.ajax.reload();
