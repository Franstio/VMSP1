        ...
        <form id="frm1">
            <div class="d-flex flex-column gap-2">
                ...
                <section class="d-flex flex-column" id="visitorSect">
                  ...
                  <div class="d-flex flex-column gap-2" id="visitorList">
                    <div id="visitorItem1"  class="d-flex flex-row gap-3">
                      ...
                      <button count="1" tag="del" class="btn rounded btn-danger text-white">X</button>
                    </div>
                  </div>
              ...
              <section class="gap-2 d-flex d-none  flex-column" id="supply">
                ...
                <div id="supply_item" count="1" class="d-flex flex-column gap-2">  
                  <div tag="supplyItem" count="1" class="gap-3 w-100 flex-wrap d-flex flex-row">
                    ...
                    <div class="form-group flex-grow-1">
                      <select class="form-control "  tag="Unit">
                ...
                <section id="bawaan" class="d-none">
                  <div id="bawaanList" class="d-flex flex-column gap-2">
                    <div tag="bawaanItem" count="1" class="d-flex flex-row gap-3">
                      <div class="form-group">
...
<script type="module" src="js/jquery.signature.js"></script>
 ...
 --}}  <!-- Vendor JS Files -->
  ...
  <script type="module">
    ...
    $(document).ready(function(){
      ...
      $("#visitorItem1 button[tag='del']").on('click',function(){
          $("#visitorItem" + $(this).attr("count")).remove();
        });
        
      $("div[tag='supplyItem'] button[tag='del']").on('click',function(){
          $("div[tag='supplyItem']" ).remove();
        });
        $("div[tag='bawaanItem'] button[tag='del']").on('click',function(){
          $("div[tag='bawaanItem']" ).remove();
        });
      $.ajax({
        url: "/hosts",
        method:"GET",
      ...
      $("#bawaanBtn").on('click',function(){
        let s = bawaanItem.clone();
        itemCount = itemCount+1;
        $(s).attr("count",itemCount).find("button").on('click',function(){
          $(s).remove();
        });
        s.appendTo("#bawaanList");
      });
      ...
      $("#visitorBtn").on('click',function(){
        ...
        $("#visitorItem"+VisitorCount + " button[tag='del']").attr("count",VisitorCount).on('click',function(){
          $("#visitorItem" + $(this).attr("count")).remove();
        });
      ...
      $("#btnAdd").on('click',function(){
        ...
        $(s).attr("tag","supplyItem"+SupplyItemCount).find("button").on('click',function(){
          $(s).remove();
        });
        s.appendTo("#supply_item");
      });
