...
<main id="main" class="main">
    <section class="section dashboard">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h4 class="mt-5 mb-2 text-gray-800"><strong>Role Data</strong></h4>
        </div>
            ...
            <div class="col-md-8">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="table_role" class="display" style="width:100%">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel"><strong>Data Role</strong></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" name="nameRole" id="nameRole">
                        </div>
                        </div>
